...
- **`[NEW]` Arcade Hub:** Access interactive minigames designed to test your luck and skills.
    - **Kitty Cards:** A card game where you play against your favorite companions (Normal and Advanced Game Modes).
